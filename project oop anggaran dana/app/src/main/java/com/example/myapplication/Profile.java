    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteaccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setMessage("Deleting this account will result in completely removing your account from AnDana and you will no longer be able to access this account. " +
